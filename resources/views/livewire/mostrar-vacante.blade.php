<div>
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-4 p-4 my-10 bg-gray-100 dark:bg-gray-700">
    ...
    @guest
        <div class="mt-5 bg-gray-50 dark:bg-gray-700 dark:border-gray-500 border border-dashed p-5 text-center">
