                ...
                <div class="md:grid md:grid-cols-3 gap-5">
                    <div class="mb-5">
                        ...
                        <input
                            ...
                            class="rounded-md shadow-sm dark:bg-slate-300 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full"
                        />
                    </div>
    
                    <div class="mb-5">
                        <label class="block mb-1 text-sm text-gray-700 dark:text-gray-300 uppercase font-bold">Categoría</label>
                        <select wire:model.live='categoria' class="border-gray-300 dark:bg-slate-300 p-2 w-full">
                    ...
                    <div class="mb-5">
                        ...
                        <select wire:model.live='salario' class="border-gray-300 dark:bg-slate-300 p-2 w-full">
                            <option value="0">-- Seleccione --</option>
